/**
 * auth.js — Authentication handler for IRS e-Services
 * Supports: SSO (Login.gov / ID.me), MFA (ID.me / SMS / Video Call)
 *
...
const BASE_URL = process.env.IRS_E_SERVICES_URL || 'https://la.www4.irs.gov/esrv/ola/login';
const USERNAME = process.env.IRS_E_SERVICES_USERNAME;
const PASSWORD = process.env.IRS_E_SERVICES_PASSWORD;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set IRS_E_SERVICES_USERNAME and IRS_E_SERVICES_PASSWORD in .env`);
  }

  console.log('Logging in to IRS e-Services...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
