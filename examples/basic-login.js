/**
 * basic-login.js — Basic login example for IRS e-Services
...
async function main() {
  ...
  try {
    log('Starting IRS e-Services automation (Open Source mode)');
    ...
    const result = await login_irs(page, {
    ...
    // const data = await tin_match(page, {});
    // log('Data:', data);
